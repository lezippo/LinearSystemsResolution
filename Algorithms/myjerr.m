function [x,ierr,errore,iter,raggio]=myjerr(a,r,c,b,x0,Kmax,tol)
% purpose: solve the system of equations Ax=b using the iterative method of Jacobi
%
% syntax: [x, ierr, err, k] = myjerr(a, r, c, b, x0, Kmax, tol)
% input:
...
% kmax = 100;
%
% [x, ierr, err, k] = myjerr(a, r, c, b, x0, kmax, tol)
